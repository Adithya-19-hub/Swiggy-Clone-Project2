...
let array1 = [
    { names: "Pune - Solapur Restaurants" },
    { names: "Birati Restaurants" },
    { names: "Town Hall Restaurants" },
    { names: "Ganesh Nagar Restaurants" },
    { names: "Bhosari Restaurants" },
    { names: "Akurdi Restaurants" },
    { names: "Sector 70A Restaurants" },
    { names: "Pune Cantt Restaurants" },
    { names: "Camp Area Restaurants" },
    { names: "Pashan Restaurants" },
    { names: "Punawala Restaurants" },
    { names: "Lulla Nagar Restaurants" },
    { names: "Lohgaon Restaurants" },
    { names: "Kalyani Restaurants" },
    { names: "Saraswathi Restaurants" },
...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>South Pune Restaurants</a></div>";
...
function fun10() {
    ...
    p.innerHTML = "<span>experience. Make your reservations today and discover your new favorite spot! Let Pune's culinary delights take you on a gastronomic journey like never before.</span>";
    p.style.color = 'grey';
