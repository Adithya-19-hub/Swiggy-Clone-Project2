...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>Mitraon</a></div>";
...
function fun10() {
    ...
    p.innerHTML = "<span>But no worries, as Swiggy is here to help you. Just take a pause, order food online in Mumbai, and you can resume work.</span>";
    p.style.color = 'grey';
