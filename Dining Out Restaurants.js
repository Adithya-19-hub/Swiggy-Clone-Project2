...
let array1 = [
    ...
    { names: "Kodathi Restaurants" },
    { names: "Haralur Restaurants" },
    { names: "Bellandur Restaurants" },
    { names: "Malleshwaram Restaurants" },
    { names: "Peenya Restaurants" },
    { names: "Devanahalli Restaurants" },
    { names: "VV Mohalla Restaurants" },
    { names: "Shivaji Nagar Restaurants" },
...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>Halasuru Restaurants</a></div>";
...
function fun10() {
    ...
    p.innerHTML = "<span>experience. Make your reservations today and discover your new favorite spot! Let Bangalore's culinary delights take you on a gastronomic journey like never before.</span>";
    p.style.color = 'grey';
