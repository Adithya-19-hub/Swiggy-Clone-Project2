...
let array1 = [
    { names: "Ruby Area Restaurants" },
    { names: "Howrah AC Restaurants" },
    { names: "Kolkata Cantt Restaurants" },
    { names: "Tilgilal Restaurants" },
    { names: "Golf Green Restaurants" },
    { names: "Sohna Restaurants" },
    { names: "North Kolkata Restaurants" },
    { names: "Joka Restaurants" },
    { names: "Sector 143 Restaurants" },
    { names: "Town Hall Restaurants" },
    { names: "Kolkata Restaurants" },
    { names: "Adithya Restaurants" },
    { names: "Bally Restaurants" },
    { names: "Porur Restaurants" },
...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>South Kolkata Restaurants</a></div>";
...
function fun10() {
    ...
    p.innerHTML = "<span>experience. Make your reservations today and discover your new favorite spot! Let Kolkata's culinary delights take you on a gastronomic journey like never before.</span>";
    p.style.color = 'grey';
