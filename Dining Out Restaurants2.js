...
let array1 = [
    { names: "Manesar Restaurants" },
    { names: "Sector 29 Restaurants" },
    { names: "Sector 7 Restaurants" },
    { names: "Kapashera Restaurants" },
    { names: "dlf phase 1 Restaurants" },
    { names: "Khan markets Restaurants" },
    { names: "Prashant Restaurants" },
    { names: "Sector 82A Restaurants" },
    { names: "Sushant Lok Restaurants" },
    { names: "Chanakyapuri Restaurants" },
    { names: "Old Airport Road Restaurants" },
    { names: "Jakkur Restaurants" },
    { names: "Sector 7 Restaurants" },
    { names: "Town Hall Restaurants" },
    { names: "Hazra Restaurants" },
    { names: "Aaya Nagar Restaurants" },
];
...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>Sector 6 Restaurants</a></div>";
...
function fun10() {
    ...
    p.innerHTML = "<span>experience. Make your reservations today and discover your new favorite spot! Let Gurgaon's culinary delights take you on a gastronomic journey like never before.</span>";
    p.style.color = 'grey';
