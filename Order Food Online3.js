...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>Dabirpur</a></div>";
...
// When the user clicks this function logic will trigger.
function fun3() {
    e.innerHTML = "<div class='Swiggy-boxes'><a href='#'>Beef Biryani</a></div>"
...
function fun10() {
    ...
    p.innerHTML = "<span>But no worries, as Swiggy is here to help you. Just take a pause, order food online in Hyderabad, and you can resume work.</span>";
    p.style.color = 'grey';
