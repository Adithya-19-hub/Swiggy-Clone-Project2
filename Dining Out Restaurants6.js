...
let array1 = [
    { names: "Padapai Restaurants" },
    { names: "Tambaram Restaurants" },
    { names: "Town Hall Restaurants" },
    { names: "George Town Restaurants" },
    { names: "Chepak Restaurants" },
    { names: "Jail Road Restaurants" },
    { names: "Sector 70A Restaurants" },
    { names: "Chennai Cantt Restaurants" },
    { names: "Sainik Farms Restaurants" },
    { names: "Sector 143 Restaurants" },
    { names: "Egattur Restaurants" },
    { names: "Anang Lok Restaurants" },
    { names: "Anna Salai Restaurants" },
    { names: "Town Hall Restaurants" },
...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>South Chennai Restaurants</a></div>";
...
function fun10() {
    ...
    p.innerHTML = "<span>experience. Make your reservations today and discover your new favorite spot! Let Chennai's culinary delights take you on a gastronomic journey like never before.</span>";
    p.style.color = 'grey';
