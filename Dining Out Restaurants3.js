...
let array1 = [
    { names: "Ramnas Pura Restaurants" },
    { names: "Kapra Restaurants" },
    { names: "PG Road Restaurants" },
    { names: "Boduppal Restaurants" },
    { names: "Santosh Nagar Restaurants" },
    { names: "Madeenaguda Restaurants" },
    { names: "Pocharam Restaurants" },
    { names: "Padma Rao Nagar Restaurants" },
    { names: "Meerpet Restaurants" },
    { names: "Shankarpalle Restaurants" },
    { names: "Malakpet Restaurants" },
    { names: "Nagole Restaurants" },
    { names: "Dilsukhnagar Restaurants" },
    { names: "Nizampet Restaurants" },
    { names: "Kondapur Restaurants" },
    { names: "Film Nagar Restaurants" },
];
...
function foo() {
    b.innerHTML = "<div class='Swiggy-boxes'><a href='#'>ECIL Restaurants</a></div>";
...
function fun10() {
    ...
    p.innerHTML = "<span>experience. Make your reservations today and discover your new favorite spot! Let Hyderabad's culinary delights take you on a gastronomic journey like never before.</span>";
    p.style.color = 'grey';
